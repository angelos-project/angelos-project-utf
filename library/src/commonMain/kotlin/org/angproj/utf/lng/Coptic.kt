...
import org.angproj.utf.scr.Coptic
import org.angproj.utf.scr.Greek

public object Coptic : UtfLanguage {
    override val name: String = "Coptic"
    override val short: String = ""
    override val long: String = "cop"

    override val scripts: Set<Script> = setOf(Arabic, Coptic, Greek)
}
