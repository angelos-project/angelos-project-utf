...
import org.angproj.utf.scr.Tirhuta

public object Maithili : UtfLanguage {
    override val name: String = "Maithili"
    override val short: String = ""
    override val long: String = "mai"

    override val scripts: Set<Script> = setOf(Devanagari, Tirhuta)
}
