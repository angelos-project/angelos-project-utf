...
import org.angproj.utf.scr.OlChiki
import org.angproj.utf.scr.Oriya

public object Santali : UtfLanguage {
    override val name: String = "Santali"
    override val short: String = ""
    override val long: String = "sat"

    override val scripts: Set<Script> = setOf(Bengali, Devanagari, Latin, OlChiki, Oriya)
}
