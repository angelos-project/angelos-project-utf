...
public object DerivedGeneralCategoryParser : DataLoader<Triple<String, String, String>>() {
...
public fun startValidator(out: PrintWriter) {
    out.println(
        """
...
public fun middleValidator(out: PrintWriter) {
    out.println(
        """
                    }
        }
...
public fun endValidator(out: PrintWriter) {
    out.println(
        """
            }
        }
