...
public object Kuvi : UtfLanguage {
    override val name: String = "Kuvi"
    override val short: String = ""
    override val long: String = "kxv"

    override val scripts: Set<Script> = setOf(Devanagari, Latin, Oriya, Telugu)
}
